...
class ToReceiveFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        recyclerView = view.findViewById(R.id.recyclerViewToReceive)
        ...
        ordersViewModel.toReceiveOrders.observe(viewLifecycleOwner) { orders ->
            Log.d("DEBUG", "ToReceiveFragment - Orders Updated: ${orders.size}")
